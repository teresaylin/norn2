...
public class ListHandler implements HttpHandler {
     ...
     */
     ...
     public void handle(HttpExchange exchange) throws IOException {
         ...
         String parsed = parseInput(in);
         createResponse(parsed, out);
     }

     /**
      * Parses input stream into valid list expression
      * @param in InputStream from http request
      ...
      */
     private void createResponse(String parsed, OutputStream out) {
         PrintWriter outWriter = new PrintWriter(out, true);
         outWriter.println(""); // TODO put actual response
         outWriter.close();
     }
