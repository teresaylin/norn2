...
public interface ListExpression {
    ...
    /**
     * For a listname, gets the ListExpression(s) associated with that listname.
     * @param environment the environment containing all stored listnames
     * @return the set of ListExpressions that make up a listname
     */
